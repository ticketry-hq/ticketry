...
class StatePatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["color", "group", "name", "sort_order"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatePatch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatePatch from a dict"""
        if obj is None:
            return None
