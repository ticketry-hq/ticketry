pub(crate) struct GraphRunOverride {
...
pub(crate) const RESTRICTED_MUTATIONS: &[GraphRunOverride] = &[
    GraphRunOverride {
        field: "graph_run_create",
        generated_gap: "Generated create cannot derive Project, Module, caller, policy, timestamps, and launch effects atomically.",
    ...
    GraphRunOverride {
        ...
        generated_gap: "Seaography rc.9 update_many skips pre-save hooks and cannot serialize policy refresh with launch preparation.",
    ...
    GraphRunOverride {
        ...
        generated_gap: "Seaography rc.9 delete_many has no lifecycle hook for a serialized reset and claim cascade.",
        identity_scope: "One non-null existing root identity; Project and caller authority derive from the authoritative root.",
