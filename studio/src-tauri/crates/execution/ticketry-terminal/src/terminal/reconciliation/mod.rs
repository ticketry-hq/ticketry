//! Host reconciliation of durable terminal history with verified tmux truth,
//! one runtime listing per pass. GraphQL reads remain pure database reads and
//! never invoke this work.
