...
pub const CHILD_HANDOFFS: &[ChildHandoff] = &[
    ...
    ChildHandoff {
        ...
        files_checked: &[
            ...
            "studio/src-tauri/src/terminal_persistence",
        ],
    },
    ChildHandoff {
        ticket: "CODING-866",
    ...
    ChildHandoff {
        ...
        files_checked: &[
            "studio/src-tauri/src/launch_planning",
            "studio/src-tauri/src/launch_paths",
        ],
    },
    ChildHandoff {
        ticket: "CODING-868",
        ...
        files_checked: &[
            "studio/src-tauri/src/terminal_persistence/mod.rs",
            "studio/src-tauri/src/terminal_persistence/graphql_scope.rs",
    ...
    ChildHandoff {
        ...
        files_checked: &[
            "studio/src-tauri/src/terminal_viewer",
    ...
    ChildHandoff {
        ...
        files_checked: &[
            ...
            "studio/src-tauri/src/terminal_lifecycle/spool_layout.rs",
        ],
    },
    ChildHandoff {
        ticket: "CODING-871",
        ...
        files_checked: &["studio/src-tauri/src/terminal_launch"],
    },
    ChildHandoff {
        ticket: "CODING-872",
    ...
    ChildHandoff {
        ...
        files_checked: &[
            "studio/src-tauri/src/terminal_launch/execution.rs",
            "studio/src-tauri/src/terminal_launch/settlement.rs",
        ],
    },
    ChildHandoff {
        ticket: "CODING-874",
        ...
        files_checked: &["studio/src-tauri/src/terminal_resume"],
    },
    ChildHandoff {
        ticket: "CODING-875",
        ...
        files_checked: &["studio/src-tauri/src/terminal_cleanup"],
    },
    ChildHandoff {
        ticket: "CODING-876",
        ...
        files_checked: &["studio/src-tauri/src/terminal_reconciliation"],
    },
    ChildHandoff {
        ticket: "CODING-877",
        ...
        files_checked: &[
            "studio/src-tauri/src/terminal_reconciliation/unrecorded.rs",
            "studio/src-tauri/src/terminal_cleanup/service.rs",
        ],
    },
    ChildHandoff {
        ticket: "CODING-878",
        ...
        files_checked: &["studio/src-tauri/src/terminal_lifecycle"],
    },
    ChildHandoff {
        ticket: "CODING-879",
    ...
    ChildHandoff {
        ...
        files_checked: &[
            "studio/src-tauri/src/terminal_persistence",
            "studio/src-tauri/src/terminal_launch",
    ...
    ChildHandoff {
        ...
        files_checked: &["studio/src-tauri/src/terminal_reconciliation/service.rs"],
    },
    ChildHandoff {
        ticket: "CODING-964",
        ...
        files_checked: &["studio/src-tauri/src/terminal_reconciliation/batch.rs"],
    },
    ChildHandoff {
        ticket: "CODING-965",
        ...
        files_checked: &[
            "studio/src-tauri/src/terminal_launch/request.rs",
            "studio/src-tauri/src/launch_planning",
        ],
    },
    ChildHandoff {
        ...
        files_checked: &[
            ...
            "studio/src-tauri/src/terminal_cleanup/service.rs",
            "studio/src-tauri/src/terminal_cleanup/journal.rs",
            "studio/src-tauri/src/terminal_cleanup/effect.rs",
    ...
    ChildHandoff {
        ...
        files_checked: &[
            "studio/src-tauri/src/terminal_persistence/aggregate_seaography_audit.rs",
            "studio/src-tauri/src/terminal_persistence/child_seaography_handoffs.rs",
