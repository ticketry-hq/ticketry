...
urlpatterns = [
    ...
    path("chats", rest_api.ChatCollectionView.as_view(), name="chat-list"),
    path("chats/<str:agent_run_id>", rest_api.ChatDetailView.as_view(), name="chat-detail"),
    path("chats/<str:agent_run_id>/read", rest_api.ChatReadView.as_view(), name="chat-read"),
    path("chats/<str:agent_run_id>/resume", rest_api.ChatResumeView.as_view(), name="chat-resume"),
    path("chats/<str:agent_run_id>/turns", rest_api.ChatTurnView.as_view(), name="chat-turn"),
    path("chats/<str:agent_run_id>/interrupt", rest_api.ChatInterruptView.as_view(), name="chat-interrupt"),
    path("chats/<str:agent_run_id>/approvals", rest_api.ChatApprovalView.as_view(), name="chat-approval"),
    path("chats/<str:agent_run_id>/user-input", rest_api.ChatUserInputView.as_view(), name="chat-user-input"),
