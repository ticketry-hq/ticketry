...
class Profile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "workspace_slug", "agent_prompt", "agent_prompts", "module_links", "recent_project_id", "recent_module_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "module_links": [ModuleLink.from_dict(_item) for _item in obj["module_links"]] if obj.get("module_links") is not None else None,
