...
use crate::installation::classification::schema_facts;
...
mod tests {
    ...
    use crate::installation::adoption::Refusal;
    use crate::installation::adoption::RUST_LEAF;
    use crate::installation::classification::manifest;
