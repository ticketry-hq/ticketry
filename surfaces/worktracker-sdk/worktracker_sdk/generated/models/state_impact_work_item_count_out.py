...
class StateImpactWorkItemCountOut(BaseModel):
    """
    StateImpactWorkItemCountOut
    """ # noqa: E501
    count: StrictInt
    issue_type_id: Optional[UUID] = None
    issue_type_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["count", "issue_type_id", "issue_type_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StateImpactWorkItemCountOut from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.issue_type_name is None and "issue_type_name" in self.model_fields_set:
            _dict['issue_type_name'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StateImpactWorkItemCountOut from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "issue_type_name": obj.get("issue_type_name")
        })
        return _obj
