...
impl WorktreeStatusError {
    pub fn new(code: WorktreeStatusErrorCode, message: impl Into<String>) -> Self {
        Self {
            code,
    ...
    pub fn work_item_not_found() -> Self {
        Self::new(
    ...
    pub fn work_item_invalid(message: impl Into<String>) -> Self {
