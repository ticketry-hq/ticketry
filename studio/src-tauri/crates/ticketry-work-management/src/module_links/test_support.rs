...
pub async fn install(database: &DatabaseConnection) {
    database
        .execute_unprepared(
            r"
...
pub async fn module(database: &DatabaseConnection, id: &str, name: &str) {
...
pub async fn link(database: &DatabaseConnection, module_id: &str, path: &str) {
