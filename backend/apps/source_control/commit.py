...
from apps.source_control import checkout_lock
...
from apps.source_control.checkout import Checkout
...
def commit_worktree_changes(
    ...
    return commit_all_changes(
        task_checkout_for_action(task_id, parent_id, module_id)
    )


def commit_module_changes(module_id: str) -> CommitOutcome:
    ...
    return commit_all_changes(module_checkout_for_action(module_id))
