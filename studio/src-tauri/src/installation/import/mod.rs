...
use crate::installation::adoption::{AdoptionFailure, AdoptionPlan, Phase, Refusal};
use crate::installation::classification::PostgresSource;
...
impl StagedImport {
    ...
    pub(crate) fn into_parts(self) -> (PathBuf, String, Vec<String>) {
