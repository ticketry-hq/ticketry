...
describe("overhaul acceptance — task agent launch interaction", () => {
  it("[overhaul-76] supports keyboard choice and dismisses without stealing focus or pointer actions", async () => {
  ...
  it("[overhaul-77] invalidates changed launch context and commits once per intentional opening", async () => {
