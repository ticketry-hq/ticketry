...
pub fn owned_ledgers() -> Vec<(&'static str, i32)> {
    vec![
        ...
        (
            crate::installation_adoption::LEDGER_TABLE,
            crate::installation_adoption::ledger::VERSION,
        ),
        (
        ...
        (
            crate::terminal_persistence::LEDGER_TABLE,
            crate::terminal_persistence::VERSION,
        ),
        (
            "ticketry_execution_adoption",
            crate::execution_persistence::VERSION,
        ),
        (
            crate::documents_persistence::LEDGER_TABLE,
            crate::documents_persistence::VERSION,
        ),
        (
            crate::worktree_persistence::LEDGER_TABLE,
            crate::worktree_persistence::VERSION,
        ),
    ]
}
