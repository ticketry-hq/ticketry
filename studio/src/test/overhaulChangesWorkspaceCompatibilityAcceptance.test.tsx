...
describe("overhaul acceptance, legacy Changes workspace compatibility", () => {
  ...
  it("[overhaul-324] migrates a saved Changes target to Details when no Back origin exists", () => {
  ...
  it("[overhaul-325] removes the retired Changes tab from saved order reads and writes", () => {
    const oldOrder = [
      { kind: "changes" },
      { kind: "doc", id: "design" },
      { kind: "details" },
