...
class ChatSnapshot(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["run", "session", "events", "cursor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatSnapshot from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatSnapshot from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "run": ChatRun.from_dict(obj["run"]) if obj.get("run") is not None else None,
            "session": ChatSession.from_dict(obj["session"]) if obj.get("session") is not None else None,
            "events": [ChatEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
