...
pub struct DesktopLaunchRuntime {
...
impl DesktopLaunchRuntime {
    ...
    pub fn record(&self, runtime: ComposedCommandRuntime) {
        let _ = self.composed.set(runtime);
    }

    pub fn commands(&self) -> Result<&DatabaseConnection, String> {
    ...
    pub fn documents(&self) -> Result<DocumentsService, String> {
    ...
    pub fn stop_document_watchers(&self) {
    ...
    pub fn composed_runtime(&self) -> Result<&ComposedCommandRuntime, String> {
        self.composed()
    }
