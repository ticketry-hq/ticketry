...
class StateOut(BaseModel):
    ...
    is_protected: Optional[StrictBool] = False
    name: StrictStr
    sort_order: Optional[StrictInt] = 0
    __properties: ClassVar[List[str]] = ["color", "group", "id", "is_protected", "name", "sort_order"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StateOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StateOut from a dict"""
        if obj is None:
            return None
