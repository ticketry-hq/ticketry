...
pub const DOCUMENT_SCHEME: &str = "ticketrydoc";

/// Serve one document or asset request.
pub fn serve_document_request<R: Runtime>(
...
pub fn resolves_documents<R: Runtime>(application: &tauri::AppHandle<R>) -> bool {
