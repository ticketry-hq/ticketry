...
pub(crate) fn validate_payload(payload: &Value) -> Result<(), WorkspaceOperationError> {
...
pub(crate) fn bounded_detail(value: &str) -> Option<String> {
...
pub(crate) fn redact_text(value: &str, limit: usize) -> String {
    let redacted = value
        .split_whitespace()
        .map(|token| {
...
pub(crate) fn usable_resource_key(value: &str) -> Option<String> {
    usable_string(value)
}
