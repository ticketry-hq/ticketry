...
impl StatusEventRepository {
    pub fn new(database: DatabaseConnection, wakeup: super::status_wakeup::StatusWakeup) -> Self {
    ...
    pub fn wake_committed(&self) {
        self.wakeup.publish();
    }

    pub fn wakeup_authority_instance(&self) -> &str {
...
pub fn automation_attempt(row: automation_attempt_entity::Model) -> AutomationAttemptRecord {
...
pub fn launch_effect(row: launch_effect_entity::Model) -> LaunchEffectRecord {
    LaunchEffectRecord {
