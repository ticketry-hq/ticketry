...
pub const CUSTOM_QUERIES: &[CustomField] = &[CustomField {
    ...
    evidence: "terminal_resume::operation_registry::CUSTOM_QUERIES",
}];
...
pub const CUSTOM_MUTATIONS: &[CustomField] = &[
    ...
    CustomField {
        ...
        evidence: "terminal_output_activity::operation_registry::CUSTOM_OPERATIONS",
    },
    CustomField {
...
pub const CUSTOM_OUTPUTS: &[CustomField] = &[CustomField {
    ...
    evidence: "terminal_output_activity::graphql registers it beside its one mutation",
}];
...
pub const AUDITED_MODULES: &[&str] = &[
    ...
    "src/terminal_persistence",
    "src/terminal_launch",
    "src/terminal_cleanup",
    "src/temporary_profile",
    "src/terminal_reconciliation",
    "src/terminal_lifecycle",
    "src/terminal_output_activity",
    "src/terminal_resume",
    "src/terminal_viewer",
...
mod tests {
    use super::*;
    use crate::terminal_persistence::child_seaography_handoffs::CHILD_HANDOFFS;
