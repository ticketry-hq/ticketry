...
pub(crate) struct PullRequestCreationResult {
...
impl WorktreeChangesService {
    pub(crate) async fn create_task_pull_request(
        &self,
        task_id: &str,
        operation_id: &str,
    ...
    pub(crate) async fn replace_task_pull_request(
        &self,
        task_id: &str,
        operation_id: &str,
    ) -> Result<PullRequestCreationResult, WorktreeChangesError> {
    ...
    pub(crate) async fn follow_up_task_pull_request(
        &self,
        task_id: &str,
        operation_id: &str,
    ) -> Result<PullRequestCreationResult, WorktreeChangesError> {
    ...
    pub(crate) async fn create_module_pull_request(
        &self,
        module_id: &str,
        operation_id: &str,
    ) -> Result<PullRequestCreationResult, WorktreeChangesError> {
