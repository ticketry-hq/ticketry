...
use super::*;
use crate::persistence::RunsPersistenceErrorCode;
...
async fn a_required_drain_needs_the_root_startup_prepares_for_a_clean_profile() {
    ...
    let root = crate::hook_spool::hook_spool_directory(data_directory.path());
    ...
    crate::hook_spool::ensure_hook_spool_directory(data_directory.path())
