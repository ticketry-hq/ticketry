...
from apps.source_control.actions.pull_request_action import (
...
from apps.source_control.rest.serializers.ship_records import (
...
class ModulePullRequestViewSet(viewsets.GenericViewSet):
    ...
    def commit_push_pr(self, request):
        ...
        body.is_valid(raise_exception=True)
        outcome = commit_push_and_open_pull_request_for_module(**body.validated_data)
        return Response(WorktreePullRequestSerializer(outcome).data)
