...
impl ModuleLinkError {
    ...
    pub fn storage(message: impl Into<String>, source: sea_orm::DbErr) -> Self {
        Self {
    ...
    pub fn invalid_path(defect: LocalPathDefect) -> Self {
        Self::new(ModuleLinkErrorCode::InvalidPath, defect.message())
    }

    pub fn unknown_module(module_id: &str) -> Self {
        Self::new(
    ...
    pub fn unreadable_legacy_source(path: &PathBuf) -> Self {
        Self::new(
    ...
    pub fn unreadable_receipt(path: &PathBuf) -> Self {
        Self::new(
