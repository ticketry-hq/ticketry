...
export type WorktreeReplacePullRequestMutation = { worktree_pull_request_replace: { operation_id: string, url: string, title: string, body: string, message_source: string, branch: string, base_branch: string, pushed: boolean, uncommitted_work_excluded: boolean } };
