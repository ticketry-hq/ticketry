...
class GlobalLaunchDefault(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["provider", "model", "reasoning"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GlobalLaunchDefault from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GlobalLaunchDefault from a dict"""
        if obj is None:
            return None
