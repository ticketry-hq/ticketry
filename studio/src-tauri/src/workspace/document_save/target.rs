...
pub(crate) struct SaveTarget {
    pub(crate) row: design_document::Model,
...
pub(crate) fn for_row(row: design_document::Model) -> Option<SaveTarget> {
...
pub(crate) fn current_digest(target: &SaveTarget) -> Option<String> {
