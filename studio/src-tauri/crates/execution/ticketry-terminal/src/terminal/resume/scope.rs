...
impl ResumeScope {
    ...
    pub fn from_create(request: &CreateTerminalSession) -> Self {
        match request.kind {
    ...
    pub fn session_condition(&self) -> Condition {
        match self {
    ...
    pub fn matches_create(&self, request: &CreateTerminalSession, row: &session::Model) -> bool {
...
pub fn compact_session_column(column: session::Column) -> Expr {
