...
describe("overhaul acceptance — web settings reachability from startup gates", () => {
  ...
  it("[overhaul-210] opens Settings from the bootstrap connecting screen", async () => {
  ...
  it("[overhaul-211] opens Settings from the failed service-health screen", async () => {
    installBrowserRuntime({
      state: "failed",
  ...
  it("[overhaul-212] opens Settings while service health is not yet ready", async () => {
    installBrowserRuntime({
      state: "starting",
      service: "rust-graphql-adapter",
      message: null,
