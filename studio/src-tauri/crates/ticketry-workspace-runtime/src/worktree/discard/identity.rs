...
pub fn intent(operation_id: &str, plan: &DiscardPlan) -> WorkspaceOperationIntent {
...
pub struct DiscardIntent {
    ...
    pub cleanup: Option<CleanupExpectation>,
}
...
impl DiscardIntent {
    ...
    pub fn matches(&self, plan: &DiscardPlan) -> bool {
