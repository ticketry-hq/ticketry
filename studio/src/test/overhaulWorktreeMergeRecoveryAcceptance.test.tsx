...
describe("overhaul acceptance - divergent local merge recovery", () => {
  it("[overhaul-288] reports a completed divergent merge and converges affected Changes reads", async () => {
    const reads: string[] = [];
    let merged = false;
  ...
  it("[overhaul-289] keeps a destination conflict recoverable after source work continues and the view reopens", async () => {
  ...
  it("[overhaul-290] finishes only the staged resolution after confirmation and remains retryable after hook failure", async () => {
  ...
  it("[overhaul-291] aborts only the matching merge and preserves recovery controls after refusal", async () => {
  ...
  it("[overhaul-292] reports externally finished and aborted merges truthfully after restart", async () => {
  ...
  it("[overhaul-293] retires finished and aborted recovery so the worktree can merge again", async () => {
