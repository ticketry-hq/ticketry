...
class ChatRun(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agent_run_id", "project_id", "module_id", "task_id", "agent", "run_kind", "scope", "status", "state", "started_at", "ended_at", "cwd"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatRun from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatRun from a dict"""
        if obj is None:
            return None
