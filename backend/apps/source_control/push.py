...
def _diverged(pushable: Pushable) -> PushOutcome:
    return PushOutcome(
        remote=pushable.remote,
        branch=pushable.branch,
...
def _rejected(pushable: Pushable) -> PushOutcome:
    return PushOutcome(
        remote=pushable.remote,
        branch=pushable.branch,
...
def _published(
    pushable: Pushable, standing: BranchPosition, head: str
) -> PushOutcome:
