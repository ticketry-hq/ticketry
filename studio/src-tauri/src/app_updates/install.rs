...
pub(crate) const UPDATE_PROGRESS_EVENT: &str = "desktop-update-progress";
...
pub(crate) fn map_operation_error(error: UpdaterError) -> AppUpdateOperationError {
    match error {
...
pub(crate) fn restart_into_update(app: &tauri::AppHandle) {
