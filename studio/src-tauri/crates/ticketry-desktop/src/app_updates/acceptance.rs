...
pub fn acceptance_phase(installed_version: &str, expected_version: &str) -> AcceptancePhase {
...
pub fn after_relaunch_evidence(
...
pub fn merge_evidence(existing: Option<Value>, evidence: Map<String, Value>) -> Value {
...
pub fn record_evidence(result_path: &Path, evidence: Map<String, Value>) -> std::io::Result<()> {
...
pub fn run_if_requested(app: &tauri::AppHandle) {
