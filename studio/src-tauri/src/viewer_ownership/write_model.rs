...
pub(crate) enum ViewerLeaseModelWrite {
...
pub(crate) struct PreparedViewerLeaseWrite {
    pub(crate) write: ViewerLeaseModelWrite,
    pub(crate) permit: ViewerLeaseWritePermit,
}

pub(crate) struct ViewerLeaseWritePermit {
...
impl ViewerOwnershipService {
    pub(crate) async fn prepare_create_write(
        &self,
    ...
    pub(crate) async fn prepare_update_write(
        &self,
    ...
    pub(crate) async fn prepare_delete_write(
        &self,
