...
class WorktreeCommitPush(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "steps", "branch", "remote", "commit_sha", "subject", "message_source", "file_count", "insertions", "deletions", "pushed_sha", "failure_code", "commit_shas", "action_id", "ship_record"]
