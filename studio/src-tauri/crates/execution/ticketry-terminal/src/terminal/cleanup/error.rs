...
impl TerminalCleanupError {
    pub fn new(code: TerminalCleanupErrorCode, message: impl Into<String>) -> Self {
        Self {
            code,
    ...
    pub fn storage(source: DbErr) -> Self {
        Self {
...
impl From<ticketry_runs::RunsPersistenceError> for TerminalCleanupError {
