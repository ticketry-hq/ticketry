...
class WorkItemCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "issue_type_id", "state_id", "parent_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkItemCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkItemCreate from a dict"""
        if obj is None:
            return None
