...
nothing (:mod:`apps.source_control.gh_cli`).
...
from apps.source_control.change_status import collect_changes
from apps.source_control.default_branch import (
...
class PullRequestTarget:
    ...
    Its existence is the proof, the same way :class:`~apps.source_control.push.Pushable`
