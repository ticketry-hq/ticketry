...
impl DiscardExecutor {
    ...
    pub fn work_items(&self) -> &DatabaseConnection {
        &self.work_items
    }

    pub fn git(&self) -> &GitPort {
        &self.git
    }
    ...
    /// same subject.
    pub async fn resubject(&self, intent: &DiscardIntent) -> Result<Subject, WorktreeDiscardError> {
    ...
    /// settlement.
    pub async fn perform(&self, claim: &ClaimedOperation) -> WorkspaceOperationOutcome {
