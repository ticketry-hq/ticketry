pub(crate) struct CustomQueryRegistration {
...
pub(crate) const CUSTOM_QUERIES: &[CustomQueryRegistration] = &[CustomQueryRegistration {
    ...
    implementation: "SeaORM entities in terminal_resume::query",
    parity_test: "terminal_resume::custom_query_matches_generated_agent_run_fields",
    bounded_test: "terminal_resume::resumable_query_is_bounded_to_ten_conversations",
}];
