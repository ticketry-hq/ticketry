...
class ScopeRef(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScopeRef from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if state_group (nullable) is None
        # and model_fields_set contains the field
        if self.state_group is None and "state_group" in self.model_fields_set:
            _dict['state_group'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScopeRef from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "state_group": obj.get("state_group")
        })
        return _obj
