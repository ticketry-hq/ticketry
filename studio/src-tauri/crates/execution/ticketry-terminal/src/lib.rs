...
pub use terminal::cleanup::{
    ...
    RuntimeSnapshot, TerminalCleanupError, TerminalCleanupErrorCode, TerminalCleanupRecoveryReport,
...
pub use terminal::instant_run_ticket::{
    ...
    InstantRunTicketQuery, InstantRunTicketTitleService, INSTANT_RUN_TICKET_LIMIT,
};
...
pub use terminal::persistence::{
    ...
    ensure_adopted as ensure_terminal_persistence_adopted, owned_tables as owned_terminal_tables,
    preflight as preflight_terminal_persistence, reconciled_handoffs,
    register_graphql as register_persistence_graphql, terminals_adopted, AdoptionEvidence,
    ChildHandoff, CustomField, CustomFieldKind, HandoffImpact, HandoffStatus, PreservationCheck,
    RawSqlEvidence, RegisteredEntity, SourceClassification as TerminalSourceClassification,
    TableEvidence, TerminalPersistenceError, TerminalPersistenceErrorCode, TerminalReadScope,
    ADOPTED_TABLES as TERMINAL_ADOPTED_TABLES, AUDITED_MODULES, CHILD_HANDOFFS,
    CLEANUP_EFFECT_COLUMNS, CURRENT_DJANGO_LEAF as TERMINAL_CURRENT_DJANGO_LEAF, CUSTOM_MUTATIONS,
    CUSTOM_OUTPUTS, CUSTOM_QUERIES, EMPTY_DJANGO_LEAF, GENERATED_MUTATION_GAPS, GENERATED_WRITES,
