...
class ProjectIn(BaseModel):
    """
    Body for project create — name + slug, optional workspace.  ``workspace_slug`` is omitted on single-workspace installs; the route then resolves the sole workspace.
    """ # noqa: E501
    description: Optional[StrictStr] = None
    name: StrictStr
    slug: StrictStr
    workspace_slug: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["description", "name", "slug", "workspace_slug"]
