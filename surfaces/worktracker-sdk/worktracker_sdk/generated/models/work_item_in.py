...
class WorkItemIn(BaseModel):
    """
    Body for a project-scoped task create.  ``parent_id`` is the module (a module id) or the parent task (a task id), or null for an unparented task.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "issue_type_id", "name", "parent_id", "state_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkItemIn from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkItemIn from a dict"""
        if obj is None:
            return None
