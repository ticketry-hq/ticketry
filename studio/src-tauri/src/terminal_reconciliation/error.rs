...
impl From<crate::terminal_launch::TerminalLaunchError> for TerminalReconciliationError {
    fn from(error: crate::terminal_launch::TerminalLaunchError) -> Self {
        Self::new(TerminalReconciliationErrorCode::Launch, error.to_string())
    }
}

impl From<crate::terminal_cleanup::TerminalCleanupError> for TerminalReconciliationError {
    fn from(error: crate::terminal_cleanup::TerminalCleanupError) -> Self {
