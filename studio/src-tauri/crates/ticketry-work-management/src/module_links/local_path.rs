...
//! instant. The launch slice's folder preflight still refuses an unusable
//! folder before a run starts; this boundary only refuses a value no folder could ever be.
