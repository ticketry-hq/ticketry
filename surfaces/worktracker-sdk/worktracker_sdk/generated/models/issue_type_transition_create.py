...
class IssueTypeTransitionCreate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["from_state", "to_state", "agent_allowed", "workflow_revision"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueTypeTransitionCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueTypeTransitionCreate from a dict"""
        if obj is None:
            return None
