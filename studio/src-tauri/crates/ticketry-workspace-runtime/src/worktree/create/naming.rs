...
pub fn checkout_name(ticket_seq: Option<i32>, slug: &str) -> String {
    match ticket_seq {
...
pub fn branch_name(checkout_name: &str) -> String {
...
pub fn checkout_path(repository: &Path, checkout_name: &str) -> PathBuf {
