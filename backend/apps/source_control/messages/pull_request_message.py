...
(:mod:`apps.source_control.messages.commit_message`) and the same fixed order, because
...
from apps.source_control.messages.message_generators import run_generator
