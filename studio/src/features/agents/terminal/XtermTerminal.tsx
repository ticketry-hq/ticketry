...
// The xterm compatibility renderer. Loaded on demand through
// xtermTerminalLoader so desktop builds, which render with embedded native
// libghostty, never download xterm unless the native renderer steps aside.
